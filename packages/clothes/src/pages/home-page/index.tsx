...
import "./style.scss"
import { preInstall } from "../../utils/dep";
...
const HomePage: FC<{
	...
	const reqProjectList = useCallback(async () => {
	...
	const openProject = async (renderConfig: RenderConfig, pid: string) => {
		dispatch(actImportJson(renderConfig))
		dispatch(actPid(pid))
		setWorkState(WorkState.Installing)
		await preInstall(renderConfig, pid)
