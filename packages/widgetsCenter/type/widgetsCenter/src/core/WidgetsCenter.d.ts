...
export declare const createPkg: <T = any>(Comp: ReactComp<WidgetProps<T>>, getDescription: (...args: any) => WidgetDescription<T>, Configuration?: import("react").FC<WidgetConfigProp<T>> | import("react").ComponentClass<WidgetConfigProp<T>, any> | undefined) => WidgetPackage;
export {};
