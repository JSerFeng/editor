...
export const defaultDescription: Required<WidgetDescription> = {
	name: "no-name",
	showName: "未命名",
	snapShot: "",
	version: "*",
...
export const createPkg = <T = any>(
	...
	getDescription: WidgetDescription<T> | ((...args: any) => WidgetDescription<T>),
	Configuration?: ReactComp<WidgetConfigProp<T>>
): WidgetPackage => {
	const description: (...args: any) => WidgetDescription<T> = getDescription instanceof Function
		? getDescription
		: () => getDescription;
