...
import v-svg from "./widgets/v-svg";

const { FC: Rectangle } = rectangle;
const { FC: Text } = text;
const { FC: V-svg } = v-svg;
...
const RenderMain: FC = () => {
  return (
	...
	>
		<Rectangle 
			config={{
  "backgroundColor": "rgba(141, 156, 103, 1)",
  "opacity": "1",
  "bgImage": "",
  "bgSize": "auto",
  "borders": [
